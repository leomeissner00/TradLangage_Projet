...
type info =
  ...
  (*Information associé à une loop : son nom, une string contenant la première étiquette nécessaire lors d'un appel d'un continue, une 2eme string contenant la 2ème étiquette nécessaire lors d'un appel d'un break*)
...
(* Modifie les 2 étiquettes à partir d'une infoLoop*)
val modifier_string_break : string -> string -> info_ast -> unit
