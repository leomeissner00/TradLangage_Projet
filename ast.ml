...
and instruction =
  ...
  (* ConditionnelleOptionnelle représentée par la condition, le bloc then *)
  ...
  (*Boucle Loop représentée par son identifiant et le bloc d'instructions*)
  | Loop of string * bloc
  (*Break d'une loop représentée par son identifiant*)
  | Break of string
  (*Continue d'une loop représentée par son identifiant*)
  | Continue of string
...
struct
  ...
  and instruction =
    ...
    | Loop of Tds.info_ast * bloc (*Le nom de l'identifiant est remplacé par ses informations*)
    | Break of Tds.info_ast (*Le nom de l'identifiant est remplacé par ses informations*)
    | Continue of Tds.info_ast (*Le nom de l'identifiant est remplacé par ses informations*)
