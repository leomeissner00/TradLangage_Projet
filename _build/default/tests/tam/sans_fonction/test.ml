...
let%expect_test "testifseul1" =
  runtam (pathFichiersRat^"testifseul1.rat");
  [%expect{| 2 |}]

let%expect_test "testifseul2" =
  runtam (pathFichiersRat^"testifseul2.rat");
  [%expect{| 2 |}]
...
let%expect_test "ternaire" =
  runtam (pathFichiersRat^"testTernaire.rat");
  [%expect{| [1/3] |}]

(*Ce test ne fonctionne pas et je ne parviens pas à comprendre pourquoi*)
(*let%expect_test "loopNommer1" =
  runtam (pathFichiersRat^"testLoopNommer1.rat");
  [%expect{| 1234567891011121314151617181920212223 |}]*)
